...
###############################################################
# STEP 1: Normalize Bracken species-level data per Project
###############################################################

# NOTE: Repeat this step separately for each Cohort/Project:

df = pd.read_csv('your_path/Cohort1_Species.csv')  # Replace filename as needed
...
aggregated_df.to_csv('your_path/Corrected_Cohort1_species.csv', index=False)
...
df1 = pd.read_csv('your_path/Corrected_Cohort1_species.csv')
df2 = pd.read_csv('your_path/Corrected_Cohort2_species.csv')
df3 = pd.read_csv('your_path/Corrected_Cohort3_species.csv')
...
metadata_relevant = merged_data[[
    'Sample_ID', 'Project', 'Group', 'Country',
    'Age', 'BMI', 'Continent',
    'Instrument', 'Center_name', 'Sex'
